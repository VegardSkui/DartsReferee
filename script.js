...
function updateCurrent() {
    ...
    // Enable or disable the confirm button (the current hit count must be three or total current score must be >= 301)
...
document.getElementById('board-confirm-button').onclick = () => {
    ...
    if (currentScore == 301) {
        ...
        // Undo the score change since the player is above
